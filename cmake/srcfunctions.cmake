...
function(add_dist_library)
    ...
    if(WIN32 AND BUILD_SHARED_LIBS)
        ...
        configure_file("${CMAKE_SOURCE_DIR}/src/coalition_ulsprocessor/src/libinfo.rc.in" "${CMAKE_CURRENT_BINARY_DIR}/${ADD_DIST_LIB_TARGET}-libinfo.rc" @ONLY)
...
function(add_dist_executable)
    ...
    if(WIN32)
        ...
        set(WINRES_FILE_VERSION_STR ${WINRES_PRODUCT_VERSION_STR})
        set(WINRES_COMMENTS_STR "")
        configure_file("${CMAKE_SOURCE_DIR}/src/coalition_ulsprocessor/src/libinfo.rc.in" "${CMAKE_CURRENT_BINARY_DIR}/${ADD_DIST_BIN_TARGET}-libinfo.rc" @ONLY)
